...
export default function Sounds() {
  const [tab, setTab] = useState<'mixtape' | 'demo'>('mixtape');
  ...
  return (
    <main style={{ padding: '2rem', fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif' }}>
      ...
      <div style={{
        ...
        <button
          onClick={() => setTab('mixtape')}
          style={{
            background: 'none',
            border: 'none',
            padding: 0,
            fontSize: '1rem',
            fontWeight: tab === 'mixtape' ? 600 : 400,
            color: tab === 'mixtape' ? '#000' : '#888',
            borderBottom: tab === 'mixtape' ? '2px solid #000' : '2px solid transparent',
            cursor: 'pointer',
        ...
        <button
          ...
          style={{
            ...
            padding: 0,
            fontSize: '1rem',
            fontWeight: tab === 'demo' ? 600 : 400,
            color: tab === 'demo' ? '#000' : '#888',
            borderBottom: tab === 'demo' ? '2px solid #000' : '2px solid transparent',
            cursor: 'pointer',
            transition: 'color 0.3s ease, border-bottom 0.3s ease'
          }}
        >
