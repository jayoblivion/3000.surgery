    ...
    <div style={{
      ...
      <div style={{ marginBottom: '1.5rem' }}>
        <iframe
          width="100%"
          height="315"
          src="https://www.youtube.com/embed/uHdTfRCa4MQ?si=cLwjOIBoAyGc37vu"
      ...
      {/* 가사 */}
      <div style={{ paddingTop: '1.25rem', whiteSpace: 'pre-line', lineHeight: '1.6', color: '#333', fontSize: '0.95rem' }}>
